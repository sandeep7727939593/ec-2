...
export default function CommonModel({showModalTitle, mainContent, showButtons, buttonComponent, show, setShow}) {
        ...
        <Dialog as="div" onClose={setShow}>
            ...
            <div className="fixed inset-0 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    <div className="fixed inset-y-0 righ-0 flex max-w-full pl-10">
                    <Transition.Child
                        as={Fragment}
                        enter="ease-in-out duration-500"
                        enterFrom="opacity-0"
